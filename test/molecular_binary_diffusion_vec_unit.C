...
// H2O
  ...
  // bc gives
  const Scalar D00_exact0 = 2.528351554826481544245441087815348035e3;
  const Scalar D11_exact0 = 3.121901788240534934432311782758941744e3;
  const Scalar D22_exact0 = 6.091902339576262080292252875366557807e3;
  ...
  const Scalar D00_exact1 = 2.611264817597441081772529446947001715e3;
  const Scalar D11_exact1 = 3.224279585671193420617146528314050389e3;
  const Scalar D22_exact1 = 6.291676575280194603276673384793544978e3;
