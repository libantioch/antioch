...
int test_cp( const std::string& species_name, unsigned int species, double cp_exact, double T,
	     const Antioch::CEAThermodynamics<double>& thermo );
...
int main()
{
  ...
  const double R_N2 = Antioch::Constants::R_universal/28.016;
  const double R_O2 = Antioch::Constants::R_universal/32.0;
