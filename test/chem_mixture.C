...
int test_species( const unsigned int species,
		  const std::vector<Antioch::ChemicalSpecies<double>*>& chemical_species,
...
int main()
{
  ...
  const std::vector<Antioch::ChemicalSpecies<double>*>& chemical_species = chem_mixture.chemical_species();
  ...
  double R_exact = Antioch::Constants::R_universal*( 0.2/28.016 + 0.2/32.0 + 0.2/14.008 + 0.2/16.0 + 0.2/30.008 );
		  ...
		  double n_tr_dofs, int charge )
{
  ...
  const Antioch::ChemicalSpecies<double>& chem_species = *(chemical_species[species]);
