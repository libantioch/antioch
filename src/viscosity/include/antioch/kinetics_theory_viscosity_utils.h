...
#ifndef ANTIOCH_KINETICS_THEORY_VISCOSITY_UTILS_H
#define ANTIOCH_KINETICS_THEORY_VISCOSITY_UTILS_H
...
namespace Antioch
{
        ...
        public physical_tag_base<KineticsTheoryViscosity<CoeffType, Interpolator> >
   {
     ...
     typedef kinetics_theory_viscosity_tag viscosity_type;
   };
   ...
   void physical_set_initialize(ModelSet & mod, kinetics_theory_viscosity_tag )
   {
      ...
      build_kinetics_theory_viscosity(mod);
   }

   template<typename Model, typename StateType>
   void physical_set_operator_viscosity(const Model & set, unsigned int s, const StateType & T, StateType & mu, kinetics_theory_viscosity_tag)
   {
      mu = (*set[s])(T);
   }
