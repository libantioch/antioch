...
namespace Antioch
{
  ...
  */
  ...
  protected:
    ...
    template <typename StateType, typename VectorStateType>
    StateType Pr( const VectorStateType& molar_densities,
                  const StateType& T ) const;

    template <typename StateType, typename VectorStateType>
    void Pr_and_derivatives( const VectorStateType& molar_densities,
                             const StateType& T ,
                             const StateType& k0, 
  ...
  template<typename StateType, typename VectorStateType>
  inline
  StateType FalloffReaction<CoeffType,FalloffType>::Pr( const VectorStateType& molar_densities,
                                                        const StateType& T  ) const
  {
  ...
  template<typename StateType, typename VectorStateType>
  inline
  void FalloffReaction<CoeffType,FalloffType>::Pr_and_derivatives( const VectorStateType& molar_densities,
                                                                   const StateType& T, 
                                                                   const StateType& k0, 
                                                                   const StateType& kinf, 
                                                                   const StateType& dk0_dT, 
                                                                                                 ...
                                                                                                 VectorStateType& dkfwd_dX) const 
  {
    ...
    this->Pr_and_derivatives(molar_densities,T,k0,kinf,dk0_dT,dkinf_dT,Pr,dPr_dT,dPr_dX);
