...
#ifndef ANTIOCH_NASA_MIXTURE_PARSING_H
#define ANTIOCH_NASA_MIXTURE_PARSING_H
...
namespace Antioch
{
  ...
  void read_nasa_mixture_data( NASAThermoMixture<NumericType, CurveType >& thermo,
...
#endif // ANTIOCH_NASA_MIXTURE_PARSING_H
