...
namespace Antioch
{
  ...
  /* ------------------------- Instantiate ------------------------- */
  template void read_sutherland_data_ascii<double>( MixtureViscosity<SutherlandViscosity<double>,double >&,
						  std::istream &in );

  template void read_sutherland_data_ascii_default<double>( MixtureViscosity<SutherlandViscosity<double>,double>& mu );
