...
#ifndef ANTIOCH_KINETICS_THEORY_THERMAL_CONDUCTIVITY_UTILS_H
...
namespace Antioch
{
   ...
   struct physical_tag<KineticsTheoryThermalConductivity<ThermoEvaluator,CoeffType> >:
        public physical_tag_base<KineticsTheoryThermalConductivity<ThermoEvaluator,CoeffType> >
   {
      typedef kinetics_theory_thermal_conductivity_tag type;
        // some models require specific initialization
        // (typically automatic initialization)
     typedef kinetics_theory_thermal_conductivity_tag init_type;
     typedef kinetics_theory_thermal_conductivity_tag set_type;
        // for operators, diffusion is special, see comment below
     typedef kinetics_theory_thermal_conductivity_tag thermal_conductivity_type;
   };
   ...
   struct Initializer<KineticsTheoryThermalConductivity<ThermoEvaluator,CoeffType>, kinetics_theory_thermal_conductivity_tag >
  {
   ...
   void physical_set_initialize(ModelSet & mod, kinetics_theory_thermal_conductivity_tag)
   {
      ...
      build_kinetics_theory_thermal_conductivity(mod);
   }
