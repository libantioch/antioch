...
namespace Antioch
{
  ...
  WilkeEvaluator<Diffusion,Viscosity,ThermalConductivity,Mixture,CoeffType>::WilkeEvaluator( const Mixture& mixture,
                                                                           const Diffusion& diffusion,
                                                                           const Viscosity& viscosity,
                                                                           const ThermalConductivity& conductivity )
    : _mixture(mixture),
  ...
  template<class Diffusion, class Viscosity, class ThermalConductivity, class Mixture, class CoeffType>
  WilkeEvaluator<Diffusion,Viscosity,ThermalConductivity,Mixture,CoeffType>::~WilkeEvaluator()
  {
    return;
  }
  ...
  template<class Diffusion, class Viscosity, class ThermalConductivity, class Mixture, class CoeffType>
  template <typename StateType, typename VectorStateType>
  void WilkeEvaluator<Diffusion,Viscosity,ThermalConductivity,Mixture,CoeffType>::D( const StateType& T,
...
// \todo: Ds[s][s] not needed here
  ...
  template<class Diffusion, class Viscosity, class ThermalConductivity, class Mixture, class CoeffType>
  template <typename StateType, typename VectorStateType>
  StateType WilkeEvaluator<Diffusion,Viscosity,ThermalConductivity,Mixture,CoeffType>::mu( const StateType& T,
                                                                         const VectorStateType& mass_fractions ) const
  {
  ...
  template<class Diffusion, class Viscosity, class ThermalConductivity, class Mixture, class CoeffType>
  template <typename StateType, typename VectorStateType>
  StateType WilkeEvaluator<Diffusion,Viscosity,ThermalConductivity,Mixture,CoeffType>::k( const StateType& T,
                                                                        const VectorStateType& mass_fractions ) const
  {
  ...
  template<class Diffusion, class Viscosity, class ThermalConductivity, class Mixture, class CoeffType>
  template <typename StateType, typename VectorStateType>
  void WilkeEvaluator<Diffusion,Viscosity,ThermalConductivity,Mixture,CoeffType>::mu_and_k( const StateType& T,
                                                                          const VectorStateType& mass_fractions,
                                                                          StateType& mu_mix,
  ...
  template<class Diffusion, class Viscosity, class ThermalConductivity, class Mixture, class CoeffType>
  template <typename StateType, typename VectorStateType>
  void WilkeEvaluator<Diffusion,Viscosity,ThermalConductivity,Mixture,CoeffType>::D_and_k(const VectorStateType & mu, const StateType & T, const StateType & rho, 
...
// diffusion comes last
  ...
  template<class Diffusion, class Viscosity, class ThermalConductivity, class Mixture, class CoeffType>
  template <typename StateType, typename VectorStateType>
  void WilkeEvaluator<Diffusion,Viscosity,ThermalConductivity,Mixture,CoeffType>::mu_and_k_and_D( const StateType& T, const StateType & rho,
                                                                                          const VectorStateType& mass_fractions,
                                                                                                StateType& mu_mix,
                                                                                                StateType& k_mix,
                                                                                                VectorStateType & ds ) const
  ...
  template<class Diffusion, class Viscosity, class ThermalConductivity, class Mixture, class CoeffType>
  template <typename StateType, typename VectorStateType>
  void WilkeEvaluator<Diffusion,Viscosity,ThermalConductivity,Mixture,CoeffType>::compute_mu_chi( const StateType& T,
                                                                                const VectorStateType& mass_fractions,
                                                                                VectorStateType& mu,
                                                                                VectorStateType& chi ) const
  {
  ...
  typename
  Antioch::value_type<VectorStateType>::type
  WilkeEvaluator<Diffusion,Viscosity,ThermalConductivity,Mixture,CoeffType>::compute_phi( const VectorStateType& mu,
                                                                        const VectorStateType& chi,
                                                                        const unsigned int s ) const
  {
    using std::sqrt;
